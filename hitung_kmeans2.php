...
function caridata2($mysqli,$query){
	$row=$mysqli->query($query)->fetch_array();
	return $row[0];
}

//Inisialisasi Cluster Awal
$jumlahmahasiswa=caridata2($mysqli,"select count(*) from tb_hasil_normalisasi");
...
while ($status=='false'){
	...
	$centro1[$loop][0]=caridata2($mysqli,"select avg(var_nAKB) from tb_hasil_normalisasi where set_sementara='C1'");
	$centro1[$loop][1]=caridata2($mysqli,"select avg(var_nBBLR) from tb_hasil_normalisasi where set_sementara='C1'");
	$centro1[$loop][2]=caridata2($mysqli,"select avg(var_npremature) from tb_hasil_normalisasi where set_sementara='C1'");
	$centro1[$loop][3]=caridata2($mysqli,"select avg(var_nKP) from tb_hasil_normalisasi where set_sementara='C1'");

	//Centroid Baru Pusat 2
	$centro2[$loop][0]=caridata2($mysqli,"select avg(var_nAKB) from tb_hasil_normalisasi where set_sementara='C2'");
	$centro2[$loop][1]=caridata2($mysqli,"select avg(var_nBBLR) from tb_hasil_normalisasi where set_sementara='C2'");
	$centro2[$loop][2]=caridata2($mysqli,"select avg(var_npremature) from tb_hasil_normalisasi where set_sementara='C2'");
	$centro2[$loop][3]=caridata2($mysqli,"select avg(var_nKP) from tb_hasil_normalisasi where set_sementara='C2'");
	
	//Centroid Baru Pusat 3
	$centro3[$loop][0]=caridata2($mysqli,"select avg(var_nAKB) from tb_hasil_normalisasi where set_sementara='C3'");
	$centro3[$loop][1]=caridata2($mysqli,"select avg(var_nBBLR) from tb_hasil_normalisasi where set_sementara='C3'");
	$centro3[$loop][2]=caridata2($mysqli,"select avg(var_npremature) from tb_hasil_normalisasi where set_sementara='C3'");
	$centro3[$loop][3]=caridata2($mysqli,"select avg(var_nKP) from tb_hasil_normalisasi where set_sementara='C3'");
